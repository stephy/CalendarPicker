...
| **`renderDay`**                      | `Function`                   | Optional. Allows customization of day rendering by accepting a custom render prop that receives `{date: string; day: number, month: number, year: number, style: TextStyle}` and returns JSX Element.                                                           |                                                                                                                                                                      |
